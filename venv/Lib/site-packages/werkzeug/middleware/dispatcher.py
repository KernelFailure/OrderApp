...
This example dispatches to an API appdir under "/api", an admin appdir
under "/admin", and an appdir that serves frontend files for all other
requests::

    appdir = DispatcherMiddleware(serve_frontend, {
        '/api': api_app,
        '/admin': admin_app,
    })
